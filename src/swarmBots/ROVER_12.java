...
public class ROVER_12 {
	...
	// // constructor
	// System.out.println("ROVER_12_TEST rover object constructed");
	// rovername = "ROVER_12_TEST";
	// SERVER_ADDRESS = serverAddress;
	// sleepTime = 200; // in milliseconds - smaller is faster, but the server
	// // will cut connection if it is too small
	// }

	public ROVER_12(String roverName) {
		System.out.println("ROVER_12 rover object constructed");
		rovername = "ROVER_12";
		SERVER_ADDRESS = "localhost";
		sleepTime = 300;
	...
	// ROVER_12_TEST is also a server so it can listen to connects coming
	// from other Rovers.
	...
	public static void main(String[] args) throws Exception {
		ROVER_12 client = new ROVER_12("ROVER_12");
//		client.run();
		client.startRoverServer();
		String ipAddr = client.getIP();
		client.connect(ipAddr, RoverListenPorts.ROVER_12.getPort());
