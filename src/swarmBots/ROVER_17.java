...
public class ROVER_17 {
	...
	public ROVER_17() {
		// constructor
		System.out.println("ROVER_17 rover object constructed");
		rovername = "ROVER_17";
	...
	// // constructor
	// System.out.println("ROVER_17_TEST rover object constructed");
	// rovername = "ROVER_17_TEST";
	// SERVER_ADDRESS = serverAddress;
	// sleepTime = 200; // in milliseconds - smaller is faster, but the server
	// // will cut connection if it is too small
	// }

	public ROVER_17(String roverName) {
		System.out.println("ROVER_17 rover object constructed");
		rovername = "ROVER_17";
		SERVER_ADDRESS = "localhost";
		sleepTime = 300;
	...
	// ROVER_17_TEST is also a server so it can listen to connects coming
	// from other Rovers.
	...
	private void run() throws IOException, InterruptedException {
		...
		while (true) {
			...
			// System.out.println("ROVER_17 equipment list results drive " +
			// equipment.get(0));
	...
	private ArrayList<String> getEquipment() throws IOException {
		...
		// System.out.println("ROVER_17 incomming EQUIPMENT result - first
		...
		if (jsonEqListIn.startsWith("EQUIPMENT")) {
			while (!(jsonEqListIn = in.readLine()).equals("EQUIPMENT_END")) {
				...
				// System.out.println("ROVER_17 incomming EQUIPMENT result: " +
				// jsonEqListIn);
	...
	public void doScan() throws IOException {
		...
		if (jsonScanMapIn.startsWith("SCAN")) {
			while (!(jsonScanMapIn = in.readLine()).equals("SCAN_END")) {
				// System.out.println("ROVER_17 incomming SCAN result: " +
				// jsonScanMapIn);
		...
		// System.out.println("ROVER_17 convert from json back to ScanMap
		// class");
	...
	public static void main(String[] args) throws Exception {
		ROVER_17 client = new ROVER_17("ROVER_17");
//		client.run();
		client.startRoverServer();
		String ipAddr = client.getIP();
		client.connect(ipAddr, RoverListenPorts.ROVER_17.getPort());
