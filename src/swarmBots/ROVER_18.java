...
public class ROVER_18 {
	...
	// // constructor
	// System.out.println("ROVER_18_TEST rover object constructed");
	// rovername = "ROVER_18_TEST";
	// SERVER_ADDRESS = serverAddress;
	// sleepTime = 200; // in milliseconds - smaller is faster, but the server
	// // will cut connection if it is too small
	// }

	public ROVER_18(String roverName) {
		System.out.println("ROVER_18 rover object constructed");
		rovername = "ROVER_18";
		SERVER_ADDRESS = "localhost";
		sleepTime = 300;
	...
	// ROVER_18_TEST is also a server so it can listen to connects coming
	// from other Rovers.
	...
	public static void main(String[] args) throws Exception {
		ROVER_18 client = new ROVER_18("ROVER_18");
//		client.run();
		client.startRoverServer();
		String ipAddr = client.getIP();
		client.connect(ipAddr, RoverListenPorts.ROVER_18.getPort());
