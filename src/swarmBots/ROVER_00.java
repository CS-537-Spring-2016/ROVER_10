...
public class ROVER_00 {
	...
	private int listenPort = RoverListenPorts.ROVER_00.getPort();
	...
	// ROVER_00 is also a server so it can listen to connects coming
	// from other Rovers.
	...
	private void run() throws IOException, InterruptedException {
		...
		while (true) {
			...
			// System.out.println("ROVER_00 currentLoc after recheck: " +
			// currentLoc);
	...
	private ArrayList<String> getEquipment() throws IOException {
		...
		// System.out.println("ROVER_00 incomming EQUIPMENT result - first
		...
		if (jsonEqListIn.startsWith("EQUIPMENT")) {
			while (!(jsonEqListIn = in.readLine()).equals("EQUIPMENT_END")) {
				...
				// System.out.println("ROVER_00 incomming EQUIPMENT result: " +
				// jsonEqListIn);
	...
	public void doScan() throws IOException {
		...
		if (jsonScanMapIn.startsWith("SCAN")) {
			while (!(jsonScanMapIn = in.readLine()).equals("SCAN_END")) {
				// System.out.println("ROVER_00 incomming SCAN result: " +
				// jsonScanMapIn);
		...
		// System.out.println("ROVER_00 convert from json back to ScanMap
		// class");
	...
	public static void main(String[] args) throws Exception {
		...
		client.connect("localhost", RoverListenPorts.ROVER_99.getPort());
	}
}