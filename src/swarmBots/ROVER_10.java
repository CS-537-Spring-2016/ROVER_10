...
public class ROVER_10 {
	...
	private void run() throws IOException, InterruptedException {
		...
		while (true) {
			...
			//System.out.println("ROVER_10 equipment list results drive " + equipment.get(0));
			...
			if (blocked) {
				...
				if (goingSouth) {
					...
					// (scanMap may be old data by now)
					//System.out.println("ROVER_10 scanMapTiles[2][1].getHasRover() " + scanMapTiles[2][1].getHasRover());
					//System.out.println("ROVER_10 scanMapTiles[2][1].getTerrain() " + scanMapTiles[2][1].getTerrain().toString());
			...
			//System.out.println("ROVER_10 currentLoc after recheck: " + currentLoc);
	...
	private ArrayList<String> getEquipment() throws IOException {
		...
		//System.out.println("ROVER_10 incomming EQUIPMENT result - first readline: " + jsonEqListIn);
		...
		if(jsonEqListIn.startsWith("EQUIPMENT")){
			while (!(jsonEqListIn = in.readLine()).equals("EQUIPMENT_END")) {
				...
				//System.out.println("ROVER_10 incomming EQUIPMENT result: " + jsonEqListIn);
	...
	public void doScan() throws IOException {
		...
		if(jsonScanMapIn.startsWith("SCAN")){	
			while (!(jsonScanMapIn = in.readLine()).equals("SCAN_END")) {
				//System.out.println("ROVER_10 incomming SCAN result: " + jsonScanMapIn);
		...
		//System.out.println("ROVER_10 convert from json back to ScanMap class");
