...
public class ROVER_13 {
	...
	public ROVER_13() {
		// constructor
		System.out.println("ROVER_13 rover object constructed");
		rovername = "ROVER_13";
	...
	// // constructor
	// System.out.println("ROVER_13_TEST rover object constructed");
	// rovername = "ROVER_13_TEST";
	// SERVER_ADDRESS = serverAddress;
	// sleepTime = 200; // in milliseconds - smaller is faster, but the server
	// // will cut connection if it is too small
	// }

	public ROVER_13(String roverName) {
		System.out.println("ROVER_13 rover object constructed");
		rovername = "ROVER_13";
		SERVER_ADDRESS = "localhost";
		sleepTime = 300;
	...
	// ROVER_13_TEST is also a server so it can listen to connects coming
	// from other Rovers.
	...
	private void run() throws IOException, InterruptedException {
		...
		while (true) {
			...
			line = in.readLine();
			if (line == null) {
				System.out.println("ROVER_13 check connection to server");
				line = "";
			}
			...
			System.out.println("ROVER_13 currentLoc at start: " + currentLoc);
			...
			// equipment.get(0));
			System.out.println("ROVER_13 equipment list results " + equipment + "\n");
			...
			System.out.println("ROVER_13 blocked test " + blocked);

			// TODO - logic to calculate where to move next
			Thread.sleep(sleepTime);

			System.out.println("ROVER_13 ------------ bottom process control --------------");
		}
	}
	...
	private ArrayList<String> getEquipment() throws IOException {
		...
		// System.out.println("ROVER_13 incomming EQUIPMENT result - first
		...
		// System.out.println("ROVER_13 returnList " + returnList);
	...
	public void doScan() throws IOException {
		...
		System.out.println("ROVER_13 incomming SCAN result - first readline: " + jsonScanMapIn);
	...
	public static void main(String[] args) throws Exception {
		ROVER_13 client = new ROVER_13("ROVER_13");
//		client.run();
		client.startRoverServer();
		String ipAddr = client.getIP();
		client.connect(ipAddr, RoverListenPorts.ROVER_13.getPort());
