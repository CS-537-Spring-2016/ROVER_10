...
public class ROVER_15 {
	...
	// // constructor
	// System.out.println("ROVER_15_TEST rover object constructed");
	// rovername = "ROVER_15_TEST";
	// SERVER_ADDRESS = serverAddress;
	// sleepTime = 200; // in milliseconds - smaller is faster, but the server
	// // will cut connection if it is too small
	// }

	public ROVER_15(String roverName) {
		System.out.println("ROVER_15 rover object constructed");
		rovername = "ROVER_15";
		SERVER_ADDRESS = "localhost";
		sleepTime = 300;
	...
	// ROVER_15_TEST is also a server so it can listen to connects coming
	// from other Rovers.
	...
	public static void main(String[] args) throws Exception {
		ROVER_15 client = new ROVER_15("ROVER_15");
//		client.run();
		client.startRoverServer();
		String ipAddr = client.getIP();
		client.connect(ipAddr, RoverListenPorts.ROVER_15.getPort());
